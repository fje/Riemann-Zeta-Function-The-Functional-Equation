...
\end{equation*}
	As the integrand of $\Gamma$ is a holomorphic function of $s$ Goursat's lemma justifies that the whole expression has to be $0$. Therefore Morera's theorem finally gives us that $\Gamma(s)$ is holomorphic for $\sigma > 0$.
\end{proof}
