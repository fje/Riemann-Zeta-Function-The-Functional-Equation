...
\begin{lemma}
	Let $(a_n)_{n \in \field{N}} \in \field{C}^\field{N}$. We have
\begin{equation*}
	\prod_{n \in \field{N}} \cbr{1 + a_n} \textit{ converges} \iff \sum_{n \in \field{N}} \log(1 + a_n) \textit{ converges}.
\end{equation*}
\end{lemma}
\begin{proof} Let the infinite product be denoted by P and its partial products by $P_n$. If $P_n$ converges then
\begin{equation*}
	\lim\limits_{n \to \infty} \frac{P_n}{P_{n - 1}} = \lim\limits_{n \to \infty} 1 + a_n = 1.
\end{equation*}
	Hence $(a_n)_{n \in \field{N}}$ has to be a null sequence and
\begin{equation*}
	\exists N \in \field{N} \; \forall n > N \colon \abs{a_n} < 1
\end{equation*}
	which gives us
\begin{equation*}	
	\prod_{n \in \field{N}} \cbr{1 + a_n} = Q_N e^{\sum_{n > N} \log(1 + a_n)}
\end{equation*}
	for the principal branch of $\log(z)$ where $Q_N \in \field{C} \mysetminus \fbr{0}$. We observe that the infinite product converges or notably can't vanish if and only if the series converges.
\end{proof}


\begin{lemma}
	Let $(a_n)_{n \in \field{N}} \in \field{C}^\field{N}$. We find
\begin{equation*}
	\prod_{n \in \field{N}} \cbr{1 + \abs{a_n}} \textit{ converges} \iff \sum_{n \in \field{N}} \abs{a_n} \textit{ converges}.
\end{equation*}
\end{lemma}
\begin{proof}
	We can write
